...
public class MarioStatsX {
    ...
    public MarioStatsX(GameStatus status, float percentage, int l, int c, int time, int state, int mushrooms,
    ...
    public MarioStatsX merge(MarioStatsX other) {
        MarioStatsX merged = new MarioStatsX();
